...
namespace SuperHttpFileServer
{
    ...
    public class AppConfig
    {
        ...
        {
            new PreviewPlugin { Name = "图片预览", Category = "图片", Extensions = new List<string> { ".png", ".jpg", ".jpeg", ".gif", ".svg", ".bmp", ".webp", ".ico", ".tiff", ".tif", ".avif" } },
            new PreviewPlugin { Name = "视频预览", Category = "视频", Extensions = new List<string> { ".mp4", ".webm", ".avi", ".mkv", ".mov", ".wmv" } },
            new PreviewPlugin { Name = "音频预览", Category = "音频", Extensions = new List<string> { ".mp3", ".wav", ".ogg", ".flac", ".m4a", ".aac" } },
